...
class StanfordSentiment:
    ...
    def sentences(self):
        ...
        with open(self.path + "/datasetSentences.txt", "r") as f:
            ...
            for line in f:
                ...
                #对于python3默认的就是unicode编码。 
                # for a in splitted:
                    # print(type(a))
                    # break
                #这里是str，不是bytes啊。但是为啥报错如下：
    ...
    def sent_labels(self):
        ...
        for i in range(self.numSentences()):
            ...
            try:
                tmp = dictionary[full_sent]#
                sent_labels[i] = labels[tmp]#要是不存在这里呢？？？要考虑这种情况
            except Exception as a:
                un_expect_num = un_expect_num + 1
                # print("full_sent=",full_sent)
                # print(a)
        print("un_expect_num=",un_expect_num)
